...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().name(DEFAULT_NAME).email(DEFAULT_EMAIL).phone(DEFAULT_PHONE).jobTitle(DEFAULT_JOB_TITLE);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().name(UPDATED_NAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE).jobTitle(UPDATED_JOB_TITLE);
        return client;
    }
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getJobTitle()).isEqualTo(DEFAULT_JOB_TITLE);
    }
    ...
    void putNewClient() throws Exception {
        ...
        updatedClient.name(UPDATED_NAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE).jobTitle(UPDATED_JOB_TITLE);
        ...
        assertThat(testClient.getJobTitle()).isEqualTo(UPDATED_JOB_TITLE);
    }
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.name(UPDATED_NAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE).jobTitle(UPDATED_JOB_TITLE);
